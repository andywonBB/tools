...
-- context LIKE 'feedback' as sample_reviewed
-- context LIKE 'reviews' as product_reviewed
...
visitor_id,
--visit_id,
--MAX(CASE WHEN page_request RLIKE '/(join|subscribe/)' AND page_request RLIKE '/women' THEN '1-true' ELSE '0-false' END) AS viewed_womens_join,
--MAX(CASE WHEN page_request RLIKE '/(join|subscribe/)' AND  page_request RLIKE '/men' THEN '1-true' ELSE '0-false' END) AS viewed_mens_join,
